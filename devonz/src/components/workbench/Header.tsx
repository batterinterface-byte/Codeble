...
export function Header({
  ...
  return (
    <div className="h-13 flex items-center justify-between px-4 border-b border-border/50 bg-gradient-header flex-shrink-0 gap-2">
      <div className="flex items-center gap-2 min-w-0">
        ...
        {gitStatus && (
          <div className="flex items-center gap-1.5 ml-1 text-xs text-secondary/70 bg-surface/40 px-2 py-1 rounded-full border border-border/40">
